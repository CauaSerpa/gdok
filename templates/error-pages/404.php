                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <div class="maintenance-img">
                                        <img src="<?= INCLUDE_PATH_DASHBOARD; ?>assets/images/svg/404-error.svg" class="img-fluid" alt="coming-soon">
                                    </div>
                                    ...
                                    <a class="btn btn-primary mt-3 me-1" href="<?= INCLUDE_PATH_DASHBOARD; ?>">Back to Home</a>
                                </div>
                            </div>
                        </div>
                    </div>
