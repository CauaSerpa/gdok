...
<div class="container">
    <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
        <div class="flex-grow-1">
            <h4 class="fs-18 fw-semibold m-0">Cadastrar Tipo de Documento</h4>
        </div>
    
        <div class="text-end">
            <ol class="breadcrumb m-0 py-0">
                <li class="breadcrumb-item"><a href="<?= INCLUDE_PATH_DASHBOARD; ?>empresas">Tipos de Documentos</a></li>
                <li class="breadcrumb-item active">Cadastrar Tipo de Documento</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h5 class="card-title mb-0">Cadastro de Tipo de Documento</h5>
                </div><!-- end card header -->
...
$(document).ready(function() {
    ...
    $("#documentTypeForm").validate({
        ...
        submitHandler: function (form) {
            ...
            formData.append("action", "register-document-type");

            $.ajax({
                url: '<?= INCLUDE_PATH_DASHBOARD; ?>back-end/user/document-types/register-document-type.php',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
