<style>
    #departmentsTable_paginate .pagination {
        display: none;
    }
    .dataTables_empty {
        text-align: center;
...
<div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
    <div class="flex-grow-1">
        <h4 class="fs-18 fw-semibold m-0">Depto de Envio</h4>
    </div>

    <div class="text-end">
        <a href="<?= INCLUDE_PATH_DASHBOARD; ?>cadastrar-depto-envio" class="btn btn-dark">
            <i class="mdi mdi-plus fs-16 align-middle"></i>
            Cadastrar Depto de Envio
        </a>
    </div>
</div>
        ...
        <div class="card overflow-hidden mb-0">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <h5 class="card-title text-black mb-0">Depto cadastradas de envio</h5>
                </div>
            </div>

            <div class="card-body p-0">
                <table id="departmentsTable" class="table table-traffic mb-0">
                    <thead>
                        <tr>
                            <th>Nome da Depto de Envio</th>
                            <th>Ações</th>
                        </tr>
                    </thead>
                    <tbody></tbody>
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '.btn-delete', function () {
            ...
            $('#departmentName').text(elementNameToDelete); // Define o nome no modal
...
<script>
    $(document).ready(function () {
        ...
        const table = $('#departmentsTable').DataTable({
            ...
            ajax: {
                url: '<?= INCLUDE_PATH_DASHBOARD; ?>back-end/user/department-sending/list.php', // URL para carregar os dados
                type: 'GET',
