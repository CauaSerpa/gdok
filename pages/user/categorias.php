...
<div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
    <div class="flex-grow-1">
        <h4 class="fs-18 fw-semibold m-0">Categoria</h4>
    </div>

    <div class="text-end">
        <a href="<?= INCLUDE_PATH_DASHBOARD; ?>cadastrar-categoria" class="btn btn-dark">
        ...
        <div class="card overflow-hidden mb-0">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <h5 class="card-title text-black mb-0">Categoria cadastradas</h5>
                </div>
            </div>
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '.btn-delete', function () {
            ...
            $('#categoryName').text(elementNameToDelete); // Define o nome no modal
...
<script>
    $(document).ready(function () {
        ...
        const table = $('#categoriesTable').DataTable({
            ...
            ajax: {
                url: '<?= INCLUDE_PATH_DASHBOARD; ?>back-end/user/category/list.php', // URL para carregar os dados
                type: 'GET',
