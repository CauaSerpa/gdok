...
final class SendingDocuments extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
        $table = $this->table('tb_sending_documents');
        $table
            ...
            ->addColumn('upload_date', 'datetime', ['null' => true])
            ->addColumn('name', 'string', ['limit' => 255, 'null' => true])
            ->addColumn('reference', 'text', ['limit' => 7, 'null' => true])
    ...
    {
        // Exclui a tabela tb_sending_documents
        if ($this->hasTable('tb_sending_documents')) {
            $this->table('tb_sending_documents')->drop()->save();
        }
    }
}