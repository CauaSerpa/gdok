        ...
        <body>
            <div class='email-container'>
                ...
                <div class='email-body'>
                    ...
                    <p>Bem-vindo(a) ao " . htmlspecialchars($project['name'], ENT_QUOTES, 'UTF-8') . "!</p>
                    <p>O escritório " . htmlspecialchars($content['content']['office'], ENT_QUOTES, 'UTF-8') . " adicionou você na lista de clientes dele.</p>
                    <p>Para completar o processo de registro e ativar sua conta, por favor, clique no botão abaixo para finalizar seu cadastro:</p>
                    <a href='" . htmlspecialchars($content['content']['link'], ENT_QUOTES, 'UTF-8') . "' class='button'>Finalizar Cadastro</a>
